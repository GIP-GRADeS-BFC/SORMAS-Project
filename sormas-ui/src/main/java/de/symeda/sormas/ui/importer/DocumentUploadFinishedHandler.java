...
public class DocumentUploadFinishedHandler implements UploadFinishedHandler {
				...
				VaadinUiUtil.showConfirmationPopup(
					...
					ok -> {
						if (ok) {
							...
							try {
								saveDocument(fileName, mimeType, length, relatedEntityType, relatedEntityUuid, inputStream);
	...
	private void saveDocument(
		...
		FacadeProvider.getDocumentFacade().saveDocument(document, ByteStreams.toByteArray(inputStream));
	}
}
